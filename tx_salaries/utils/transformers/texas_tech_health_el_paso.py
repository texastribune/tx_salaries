...
class TransformedRecord(
    ...
    MAP = {
        'full_name': 'NAME',
        # 'suffix': '', if needed
        'department': 'HOME ORGANIZATION DESC',
    ...
    ORGANIZATION_NAME = 'Texas Tech University Health Sciences Center at El Paso'
    ...
    DATE_PROVIDED = date(2015, 11, 24)

    # The URL to find the raw data in our S3 bucket.
    URL = ('http://raw.texastribune.org.s3.amazonaws.com/'
           'texas_tech_health_el_paso/salaries/2015-11/'
           'texas-tech-university-health-sciences-center-at-el-paso.xls')
