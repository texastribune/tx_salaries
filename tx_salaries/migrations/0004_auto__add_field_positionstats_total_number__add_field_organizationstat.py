...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PositionStats.total_number'
        db.add_column(u'tx_salaries_positionstats', 'total_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'OrganizationStats.total_number'
        db.add_column(u'tx_salaries_organizationstats', 'total_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PositionStats.total_number'
        db.delete_column(u'tx_salaries_positionstats', 'total_number')

        # Deleting field 'OrganizationStats.total_number'
        db.delete_column(u'tx_salaries_organizationstats', 'total_number')
