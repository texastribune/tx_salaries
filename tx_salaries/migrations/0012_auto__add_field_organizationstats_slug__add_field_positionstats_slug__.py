...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganizationStats.slug'
        db.add_column(u'tx_salaries_organizationstats', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PositionStats.slug'
        db.add_column(u'tx_salaries_positionstats', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employee.slug'
        db.add_column(u'tx_salaries_employee', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganizationStats.slug'
        db.delete_column(u'tx_salaries_organizationstats', 'slug')

        # Deleting field 'PositionStats.slug'
        db.delete_column(u'tx_salaries_positionstats', 'slug')

        # Deleting field 'Employee.slug'
        db.delete_column(u'tx_salaries_employee', 'slug')
