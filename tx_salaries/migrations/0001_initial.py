...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompensationType'
        db.create_table(u'tx_salaries_compensationtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'tx_salaries', ['CompensationType'])

        # Adding model 'Employee'
        db.create_table(u'tx_salaries_employee', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('position', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tx_people.Membership'])),
            ('hire_date', self.gf('tx_people.fields.ReducedDateField')(max_length=10)),
            ('compensation', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=4)),
            ('compensation_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tx_salaries.CompensationType'])),
        ))
        db.send_create_signal(u'tx_salaries', ['Employee'])


    def backwards(self, orm):
        # Deleting model 'CompensationType'
        db.delete_table(u'tx_salaries_compensationtype')

        # Deleting model 'Employee'
        db.delete_table(u'tx_salaries_employee')
