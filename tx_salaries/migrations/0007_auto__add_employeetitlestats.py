...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tx_salaries_employeetitlestats', (
            ...
            ('highest_paid', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='title_stats_highest', null=True, to=orm['tx_salaries.Employee'])),
            ('lowest_paid', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='title_stats_lowest', null=True, to=orm['tx_salaries.Employee'])),
