...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PositionStats'
        db.create_table(u'tx_salaries_positionstats', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('position', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stats', to=orm['tx_people.Post'])),
            ('highest_paid', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stats_highest', null=True, to=orm['tx_salaries.Employee'])),
            ('lowest_paid', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stats_lowest', null=True, to=orm['tx_salaries.Employee'])),
        ))
        db.send_create_signal(u'tx_salaries', ['PositionStats'])


    def backwards(self, orm):
        # Deleting model 'PositionStats'
        db.delete_table(u'tx_salaries_positionstats')
    ...
    models = {
        ...
        u'tx_salaries.positionstats': {
            ...
            'highest_paid': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'stats_highest'", 'null': 'True', 'to': u"orm['tx_salaries.Employee']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lowest_paid': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'stats_lowest'", 'null': 'True', 'to': u"orm['tx_salaries.Employee']"}),
