...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmployeeTitle'
        db.create_table(u'tx_salaries_employeetitle', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'tx_salaries', ['EmployeeTitle'])
    ...
    def backwards(self, orm):
        # Deleting model 'EmployeeTitle'
        db.delete_table(u'tx_salaries_employeetitle')

        # Deleting field 'Employee.title'
        db.delete_column(u'tx_salaries_employee', 'title_id')
