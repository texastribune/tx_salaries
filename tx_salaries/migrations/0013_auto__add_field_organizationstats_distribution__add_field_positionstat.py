...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganizationStats.distribution'
        db.add_column(u'tx_salaries_organizationstats', 'distribution',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)

        # Adding field 'PositionStats.distribution'
        db.add_column(u'tx_salaries_positionstats', 'distribution',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganizationStats.distribution'
        db.delete_column(u'tx_salaries_organizationstats', 'distribution')

        # Deleting field 'PositionStats.distribution'
        db.delete_column(u'tx_salaries_positionstats', 'distribution')
