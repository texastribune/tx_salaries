...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmployeeTitleStats.date_provided'
        db.add_column(u'tx_salaries_employeetitlestats', 'date_provided',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EmployeeTitleStats.date_provided'
        db.delete_column(u'tx_salaries_employeetitlestats', 'date_provided')
