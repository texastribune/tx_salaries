...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrganizationStats.distribution'
        db.alter_column(u'tx_salaries_organizationstats', 'distribution', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'PositionStats.distribution'
        db.alter_column(u'tx_salaries_positionstats', 'distribution', self.gf('jsonfield.fields.JSONField')(null=True))

    def backwards(self, orm):

        # Changing field 'OrganizationStats.distribution'
        db.alter_column(u'tx_salaries_organizationstats', 'distribution', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'PositionStats.distribution'
        db.alter_column(u'tx_salaries_positionstats', 'distribution', self.gf('jsonfield.fields.JSONField')())
    ...
    models = {
        ...
        u'tx_salaries.organizationstats': {
            ...
            'distribution': ('jsonfield.fields.JSONField', [], {'null': 'True'}),
