...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PositionStats.position'
        db.alter_column(u'tx_salaries_positionstats', 'position_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['tx_people.Post']))
        # Adding unique constraint on 'PositionStats', fields ['position']
        db.create_unique(u'tx_salaries_positionstats', ['position_id'])


        # Changing field 'OrganizationStats.organization'
        db.alter_column(u'tx_salaries_organizationstats', 'organization_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['tx_people.Organization']))
        # Adding unique constraint on 'OrganizationStats', fields ['organization']
        db.create_unique(u'tx_salaries_organizationstats', ['organization_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'OrganizationStats', fields ['organization']
        db.delete_unique(u'tx_salaries_organizationstats', ['organization_id'])

        # Removing unique constraint on 'PositionStats', fields ['position']
        db.delete_unique(u'tx_salaries_positionstats', ['position_id'])


        # Changing field 'PositionStats.position'
        db.alter_column(u'tx_salaries_positionstats', 'position_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tx_people.Post']))

        # Changing field 'OrganizationStats.organization'
        db.alter_column(u'tx_salaries_organizationstats', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tx_people.Organization']))
