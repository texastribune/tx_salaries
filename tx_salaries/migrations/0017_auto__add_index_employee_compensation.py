...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Employee', fields ['compensation']
        db.create_index(u'tx_salaries_employee', ['compensation'])


    def backwards(self, orm):
        # Removing index on 'Employee', fields ['compensation']
        db.delete_index(u'tx_salaries_employee', ['compensation'])
    ...
    models = {
        ...
        u'tx_salaries.employee': {
            ...
            'compensation': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '4', 'db_index': 'True'}),
