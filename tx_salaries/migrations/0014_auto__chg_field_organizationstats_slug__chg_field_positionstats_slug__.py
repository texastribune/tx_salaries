...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrganizationStats.slug'
        db.alter_column(u'tx_salaries_organizationstats', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255, null=True))

        # Changing field 'PositionStats.slug'
        db.alter_column(u'tx_salaries_positionstats', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255, null=True))

        # Changing field 'Employee.slug'
        db.alter_column(u'tx_salaries_employee', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'OrganizationStats.slug'
        db.alter_column(u'tx_salaries_organizationstats', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))

        # Changing field 'PositionStats.slug'
        db.alter_column(u'tx_salaries_positionstats', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))

        # Changing field 'Employee.slug'
        db.alter_column(u'tx_salaries_employee', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
    ...
    models = {
        ...
        u'tx_salaries.organizationstats': {
            ...
            'distribution': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
